    ...
    return api
      .get(
        `/api/recebimento/porPagamento/${moment(resumoData?.[0]?.$d).format(
          "YYYY-MM-DD"
        )}/${moment(resumoData?.[1]?.$d).format("YYYY-MM-DD")}/${loja?loja : 0}`
      )
      .then((r) => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Footer: () => (
            <>
              <div style={{color:'red'}}> Total devido {"  "}
               <h4>
...

      {
        ...
        AggregatedCell: ({ cell }) => (
          <div style={{ backgroundColor: "green", color: "#f2f2f2" }}>
           <h4 > {cell.getValue()?.toLocaleString?.("pt-BR", {
              style: "currency",
              currency: "BRL",
              minimumFractionDigits: 2,
              maximumFractionDigits: 2,
        ...
        Footer: () => (
            <>
              <div style={{color:'green'}}> Total recebido {"  "}
      ...
      
      {
        ...
        Footer: () => (
            <>
              <Button label="Imprimir" icon="pi pi-print" className="p-button p-button-rounded" onClick={()=> imprime()}/>
          </> 
          ),
      },
    ],
                ...
                <>
                  <MaterialReactTable
                    ...
                    initialState={{
                      ...
                      columnVisibility: { numeronfce: false , jurosPago:false, multaPaga:false, desconto:false }
